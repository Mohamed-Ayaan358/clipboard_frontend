    ...
    <div class="col-sm-6 col-lg-4">
      <div class="card text-center clean-card">
        ...
        <div class="card-body info">
          ...
          <a href={props.github}>
            <img src="https://cdn.iconscout.com/icon/free/png-256/github-1521500-1288242.png" alt="GitHub" width="30px"></img>
          </a>
        </div>
      </div>
    </div>
    ...
    <>
      <nav class="navbar navbar-expand-lg navbar-dark bg-black">
        <div class="navbar-brand" style={{ paddingLeft: "10px" }} href="#">
          <img src={Pin} width="30" height="30" class="d-inline-block align-top" alt="logo"></img>
          ClipBoard
        </div>
        ...
        <div style={{ paddingRight: "10px" }}>
          <button
            class="btn"
            style={{ color: "white", backgroundColor: "#E42346", borderColor: "#E42346" }}
            type="button"
      ...
      <div main class="page landing-page" >
        <section class="cover" >
          <div class="cover-inside " style={{ marginLeft: "auto", marginRight: "auto", width: "fit-content" }}>
            <div class="card shadow" style={{ width: "500px", borderRadius: "30px" }}>
              <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
                ...
                <Typography paragraph id="tagline3" style={{ color: "#0D0C1D" }}>
        ...
        <section id="features" style={{ paddingTop: "50px" }}>
          <div class="container">
            <div class="block-heading">
              ...
              <p>
                PinBoard aims to be an extremely effective note taking app/event planning service.
                <br />
                <br />
                <b>
                  What makes it different from any normal note keeping app?
                </b>
                <br />
                We plan to add several features like an intuitive calendar and an area used to create not just notes but also share files and maintain comparison lists.
              </p>
            </div>
          </div>
        </section>
      ...
      <footer class="page-footer">
        <p><br />Copyright © ClipBoard 2021</p>
      </footer>
    </>
  );
}
  ...
  return (
    <>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-black">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarContent">
          <ul class="navbar-nav mr-md-2">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/folder">Folders</a>
            </li>
          </ul>
        </div>
      ...
      <div class="row g-0 justify-content-center">
        ...
        <div class="card text-center clean-card shadow my-3" style={{ borderRadius: "30px", width: "35%" }}>
          <div style={{ textAlign: "center" }}>
        ...
        <div class="card text-center clean-card shadow my-3" style={{ borderRadius: "30px", width: "60%" }}>

          <div class="row justify-content-center">
            <a href="/calendar" class="card card-selectable text-white bg-black text-center clean-card mx-3 my-3" style={{ textDecoration: "none", borderRadius: "30px", width: "43%" }}>
              <div class="card-body info">
            ...
            <a href="/folders" class="card card-selectable text-white bg-black text-center clean-card mx-3 my-3" style={{ textDecoration: "none", borderRadius: "30px", width: "43%" }}>
              <div class="card-body info">
                <h4 class="card-title" style={{ color: "#E42346" }} >
                  TO DO
                </h4>
          ...
          <div class="card text-center clean-card shadow mx-3 my-3" style={{ borderRadius: "30px" }}>
            <div class="card-header" style={{ backgroundColor: "#000000", color: "#E42346" }} >
